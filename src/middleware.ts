...
const ROLE_DEFAULTS: Record<string, string[]> = {
  ...
  "Accountant": ["dashboard:view","analytics:view","staff:view","departments:view","attendance:view","attendance:reports","leave:view","expenses:view","expenses:create","expenses:edit","expenses:approve","expenses:export","expenses:manage","expenses:reports","income:view","income:create","income:edit","income:approve","income:export","income:manage","income:reports","accounting:view","accounting:create","accounting:edit","accounting:approve","accounting:export","accounting:manage","accounting:reports","invoices:view","invoices:create","invoices:edit","invoices:approve","invoices:export","invoices:manage","invoices:reports","payments:view","payments:create","payments:edit","payments:approve","payments:export","payments:manage","payments:reports","payroll:view","payroll:create","payroll:preview","payroll:reports","reports:view","reports:export","reports:reports","advances:view","advances:approve","announcements:view","mail:view","mail:create","tasks:view","work-records:view"],
