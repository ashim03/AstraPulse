  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        <Card className="p-4">
          <h3 className="mb-3 text-sm font-semibold text-slate-800">Revenue vs Expenses</h3>
          <TrendChart
        ...
        <Card className="p-4">
          <h3 className="mb-3 text-sm font-semibold text-slate-800">Invoiced Amounts</h3>
          <BarChartView data={invoiceByMonth} xKey="month" series={[{ key: "value", name: "Invoiced", color: "#6366f1" }]} currency />
        </Card>
        <Card className="p-4">
          <h3 className="mb-3 text-sm font-semibold text-slate-800">Hours Logged</h3>
      ...
      <Card className="p-4">
        <h3 className="mb-3 text-sm font-semibold text-slate-800">Expenses by Category</h3>
