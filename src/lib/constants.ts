...
export const NAVIGATION: NavItem[] = [
  ...
  { label: "Attendance Dashboard", href: "/attendance/employee-dashboard", icon: UserCheck, permission: "attendance:employee_dashboard" },
  { label: "Attendance Reports", href: "/attendance/reports", icon: FileBarChart, permission: "attendance:reports" },
  { label: "Attendance Settings", href: "/attendance/settings", icon: SlidersHorizontal, permission: "attendance:settings" },
  { label: "Leave", href: "/leave", icon: CalendarDays, permission: "leave:view" },
  { label: "Holidays", href: "/holidays", icon: PartyPopper, permission: "holidays:view" },
  { label: "Tasks", href: "/tasks", icon: ListTodo, permission: "tasks:view" },
  { label: "Work Records", href: "/work-records", icon: Clock3, permission: "work-records:view" },
  { label: "Employee Advances", href: "/advances", icon: HandCoins, permission: "advances:view" },
  { label: "Payroll", href: "/payroll", icon: Wallet, permission: "payroll:view" },
  { label: "Salary Preview", href: "/payroll/preview", icon: BadgeDollarSign, permission: "payroll:preview" },
  { label: "Payroll Periods", href: "/payroll/periods", icon: CalendarClock, permission: "payroll:periods" },
  { label: "Expenses", href: "/expenses", icon: Receipt, permission: "expenses:view" },
  { label: "Income", href: "/income", icon: TrendingUp, permission: "income:view" },
  { label: "Accounting", href: "/accounting", icon: BookOpenCheck, permission: "accounting:view" },
  ...
  { label: "Financial Reports", href: "/reports", icon: LineChart, permission: "reports:view" },
  { label: "Announcements", href: "/announcements", icon: Megaphone, permission: "announcements:view" },
  { label: "Internal Mail", href: "/mail", icon: Mail, permission: "mail:view" },
  { label: "Audit Logs", href: "/audit-logs", icon: ScrollText, permission: "audit-logs:view" },
...
export const CURRENCIES = ["NPR", "USD", "EUR", "GBP", "INR", "AED", "CAD", "AUD", "SGD", "BDT", "JPY", "CNY", "KRW", "THB", "MYR", "IDR", "PHP", "VND", "LKR", "PKR", "AFN", "IRR", "SAR", "QAR", "KWD", "BHD", "OMR", "TRY", "RUB", "ZAR", "NGN", "KES", "EGP", "BRL", "MXN", "ARS", "CLP", "COP", "PEN", "NZD", "CHF", "SEK", "NOK", "DKK", "PLN", "CZK", "HUF", "RON", "BGN", "HRK", "UAH", "KZT", "UZS", "MNT", "MMK", "KHR", "LAK", "BTN", "MVR"];
